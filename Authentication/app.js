// Your web app's Firebase configuration - Replace with the config provided in your Firebase console
var firebaseConfig = {
  apiKey: "AIzaSyAipyvPKjo8kLwf1S6YZXOhAxic0W3ER9E",
  authDomain: "cloud-chat-267b6.firebaseapp.com",
  projectId: "cloud-chat-267b6",
  storageBucket: "cloud-chat-267b6.appspot.com",
  messagingSenderId: "438961779479",
  appId: "1:438961779479:web:562459c20c16573393bd52",
  measurementId: "G-74BSEJBB3N",
};
    ...
    database
      ...
      .onSnapshot((snapshot) => {
        ...
        snapshot.forEach((element) => {
          ...
          p1.textContent = element.data().item2;
          p2.textContent = element.data().item3;
